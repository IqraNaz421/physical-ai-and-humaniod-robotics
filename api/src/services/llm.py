...
class LLMService:
    ...
    def __init__(self):
     ...
     print(f"[DEBUG] API Key length: {len(settings.gemini_api_key)}")
     print(f"[DEBUG] API Key starts with: {settings.gemini_api_key[:10]}...")
     print(f"[DEBUG] Base URL: {settings.gemini_base_url}")
